...
public class LeftHandPractice extends AppCompatActivity{
    ...
    private void onRecord(boolean start, Button playRecordButton) {
        if (start) {
            ...
            Log.v("sheetsheetsheettype","type"+ RightHandReading.A_Music_Sheet_Type.getType());
        }
    }
    ...
    private void stopRecording() {
        ...
        Log.v("sheetsheetsheetstop","stoprecording");
        Log.v("sheetsheetsheetstop","stoprecording"+A_COMPARE_MUSIC_SHEET.getSheet());
        /*mRecorder.stop();
        mRecorder.release();
        mRecorder = null;*/
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_left_hand_practice);
    ...
    public void startAnalyze(){
        Intent intent = new Intent(this, LeftHandFeedback.class);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        if (menuItem.getItemId() == android.R.id.home) {
            Intent intent = new Intent(LeftHandPractice.this, LeftHandReading.class);
            startActivity(intent);
            finish();
